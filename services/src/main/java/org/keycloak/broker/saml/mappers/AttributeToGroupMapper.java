...
public class AttributeToGroupMapper extends AbstractIdentityProviderMapper {
    ...
    static {
        ...
        property.setHelpText(
            "Group to join if attribute with matching value is present. Use the full group path. Ex. '/ParentGroup/ChildGroup' or '/TopLevelGroup'."
        );
        property.setType(ProviderConfigProperty.STRING_TYPE);
        configProperties.add(property);
    }
    ...
    public String getHelpText() {
        return "If the attribute exists and has the required value, the user will become a member of the specified group.";
    }
